...
def CATEGORIES100(name, iconimage, desc, fanart):
	...
	if Custom_10001 == "true": addDir(addonString(30050).encode('utf-8'),'',10001,featherenceserviceicons_path + 'star.png',addonString(30051).encode('utf-8'),0,50,'') #AMIR ELGAZAR PLAYLISTS
...
def CATEGORIES10101(name, iconimage, desc, fanart):
	...
	addDir(addonString(30144).encode('utf-8'),list,17,'http://www.nrg.co.il/images/archive/465x349/1/403/734.jpg',addonString(30244).encode('utf-8'),'1','0',getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10106(name, iconimage, desc, fanart):
	...
	addDir(addonString(30146).encode('utf-8'),list,17,'http://img.mako.co.il/2015/05/28/EDENBENZAKEN_c.jpg',addonString(30246).encode('utf-8'),'1','0',getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES11105(name, iconimage, desc, fanart):
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30504).encode('utf-8'),list,17,"https://he.wikipedia.org/wiki/%D7%A1%D7%A7%D7%A8%D7%99%D7%9C%D7%A7%D7%A1#/media/File:Skrillex.jpg",addonString(30505).encode('utf-8'),'1','0',getAddonFanart(background, default=fanart, custom="https://wallpaperscraft.com/image/skrillex_glasses_haircut_shirt_look_7828_1920x1080.jpg"))
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30500).encode('utf-8'),list,17,"https://he.wikipedia.org/wiki/%D7%98%D7%99%D7%99%D7%A1%D7%98%D7%95#/media/File:DJ_Tiesto2005.jpg",addonString(30501).encode('utf-8'),'1','0',getAddonFanart(background, default=fanart, custom="http://www.shauntmax30.com/data/out/42/1308824-ruisufang-music-tiesto.jpg"))
