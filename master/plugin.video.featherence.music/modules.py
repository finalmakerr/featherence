...
def CATEGORIES100(name, iconimage, desc, fanart):
	...
	if Custom_10001 == "true": addDir(addonString(30050).encode('utf-8'),'',10001,featherenceserviceicons_path + 'star.png',addonString(30051).encode('utf-8'),'1',50, '') #AMIR ELGAZAR PLAYLISTS
...
def CATEGORIES111(name, iconimage, desc, fanart):
	...
	addDir(addonString(30015).encode('utf-8'),'',11105,featherenceserviceicons_path + "microphone.png",addonString(30015).encode('utf-8'),'1',58, getAddonFanart(11105)) #Foreign Djs
...
def CATEGORIES11101(name, iconimage, desc, fanart):
	...
	addDir(addonString(30327).encode('utf-8'),list,17,'http://cdn.cultofmac.com/wp-content/uploads/2015/11/adele-third-album-25.jpg',addonString(30427).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://yesofcorsa.com/wp-content/uploads/2015/09/1905_adele.jpg"))
	
	'''Aretha Franklin'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=-aVCoKV6XpVJ8U1wNNOkbo6BzgCdf83m')
	addDir(addonString(30326).encode('utf-8'),list,17,"http://sandiegofreepress.org/wp-content/uploads/2013/01/ARETHA-FRANKLIN-QUEEN-OF-SOUL.jpg",addonString(30426).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://img0.ndsstatic.com/wallpapers/54bd6b2fafd5e81b18a44a28a6cda97e_large.jpeg"))
	
	'''Beyonce'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=arPDo5YMm5RA7XMeJtn5HFDdXPed4A-X')
	addDir(addonString(30302).encode('utf-8'),list,17,"http://factmag-images.s3.amazonaws.com/wp-content/uploads/2013/05/beyonce-5.13.20132.jpg",addonString(30402).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://askkissy.com/wp-content/uploads/2016/02/image4.jpeg"))
	
	'''Bob Marley'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PLF76A601FD261FE55') 
	addDir(addonString(30322).encode('utf-8'),list,17,"http://imgc.allpostersimages.com/images/P-473-488-90/65/6544/ATK4100Z/posters/bob-marley-colors.jpg/300px-Bob-Marley-in-Concert_Zurich_05-30-80.jpg",addonString(30422).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/_KzaFxGME9o/maxresdefault.jpg"))
	
	'''Bob Dylan'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PL7B7E250ABE8B4E64&index=2&spfreload=1')
	addDir(addonString(30323).encode('utf-8'),list,17,"http://www.rockbandaide.com/wp-content/uploads/2014/02/Bob-Dylan-Times-are-Changing-C10113356.jpg",addonString(30423).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://knownpeople.net/wp-content/uploads/b/bob-dylan-wallpapers.jpg"))
	
	'''Britney Spears'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PL595EC905D80443EB')
	addDir(addonString(30350).encode('utf-8'),list,17,"http://guardianlv.com/wp-content/uploads/2013/12/Britney-Spears-Hits-Vegas-With-Piece-of-Me-Concert-Series-e1388228163153.jpg",addonString(30450).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://science-all.com/images/wallpapers/britney-spears-wallpaper/britney-spears-wallpaper-8.jpg"))
	
	'''Celine Dion'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PLVNmwycFozUGB6b6fKcldWyfmZR4RZIJj')
	addDir(addonString(30332).encode('utf-8'),list,17,"https://www.vegas.com/shows/concerts/celine-dion-las-vegas/lg_celine-dion-large-2.jpg",addonString(30432).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://wallpapers55.com/wp-content/uploads/2013/11/hd-wallpaper-celine-dion.jpg"))
	
	'''Christina Aguilera'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30307).encode('utf-8'),list,17,"http://www.billboard.com/files/styles/article_main_image/public/media/christina-aguilera_press-2013-650b.jpg",addonString(30407).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://images6.alphacoders.com/342/342248.jpg"))
	
	'''Coldplay'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PLD88DB02A8CA3EBC2')
	addDir(addonString(30329).encode('utf-8'),list,17,"http://static.guim.co.uk/sys-images/Guardian/Pix/pictures/2011/10/12/1318414177419/Coldplay-007.jpg",addonString(30429).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://worldversus.com/img/coldplay.jpg"))
	
	'''David Bowie'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PL4FA0D24F56BD0191')
	addDir(addonString(30351).encode('utf-8'),list,17,"https://wallpaperscraft.com/image/david_bowie_face_fist_sweater_look_3332_1920x1080.jpg",addonString(30451).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://www.monstersandcritics.com/wp-content/uploads/2016/01/david-bowie-album-blackstar.jpg"))
	
	'''Elton John'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PLA910D381CD5AF74E')
	addDir(addonString(30352).encode('utf-8'),list,17,"http://i.huffpost.com/gen/2722330/images/o-ELTON-JOHN-facebook.jpg",addonString(30452).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://hdwallpaperbackgrounds.net/wp-content/uploads/2015/09/Elton-John-HD-Wallpapers.jpg"))
	
	'''Elvis Presley'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PLVsyHu2yDLkzdYcDjz8yqw84CmcYZGCIt')
	addDir(addonString(30320).encode('utf-8'),list,17,"http://static.europosters.cz/image/750/plakatok/elvis-presley-portrait-i9038.jpg/375px-Elvis_Presley_promoting_Jailhouse_Rock.jpg",addonString(30420).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://www.alux.com/wp-content/uploads/2015/06/070a67ca54831a9f02541f76a8c5ec71_large_21275600.jpeg"))
	
	'''Eminem'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_ch=EminemVEVO')
	addDir(addonString(30309).encode('utf-8'),list,17,"http://static.gigwise.com/artists/best-bets-albums-eminem-650-430%20(1).jpg",addonString(30409).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://thesource.com/wp-content/uploads/2016/03/eminem-5.jpg"))
	
	'''Enrique Iglesias'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_ch=EnriqueIglesiasVEVO')
	addDir(addonString(30317).encode('utf-8'),list,17,"http://www.quoteauthors.com/wp-content/uploads/2015/10/enrique-iglesias.jpg",addonString(30417).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://images8.alphacoders.com/421/421324.jpg"))
	
	'''Eric Clapton'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PLnTKYzbTaPq4yjmTe5CwzpRUvHlJspIO7')
	addDir(addonString(30324).encode('utf-8'),list,17,"http://rock.amazingradios.com/wp-content/uploads/2014/10/eric-clapton-9.jpg",addonString(30424).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://ichef.bbci.co.uk/images/ic/1920x1080/p01hycb8.jpg"))
	...
	addDir(addonString(30318).encode('utf-8'),list,17,"http://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Jennifer_Lopez_GLAAD_2014.jpg/375px-Jennifer_Lopez_GLAAD_2014.jpg",addonString(30418).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://www.hitsync.net/wp-content/uploads/2016/04/WDF_2451822.jpg"))
	
	'''Justin Bieber'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30330).encode('utf-8'),list,17,"http://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Believe_Tour_7%2C_2012.jpg/375px-Believe_Tour_7%2C_2012.jpg",addonString(30430).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://deskbg.com/i/c/1920x1200/wpp/0/157/justin-bieber-desktop-background.jpg"))
	
	'''Katy Perry'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_ch=KatyPerryVEVO')
	addDir(addonString(30319).encode('utf-8'),list,17,"https://i.ytimg.com/vi/CevxZvSJLk8/maxresdefault.jpg",addonString(30419).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://fullhdpictures.com/wp-content/uploads/2015/05/Best-of-Katy-Perry-Wallpapers.jpg"))
	
	'''Meghan Trainor'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_ch=MeghanTrainorVEVO')
	addDir(addonString(30321).encode('utf-8'),list,17,"http://www.rosh1.co.il/wp-content/uploads/2014/12/460792920-490x429.jpg",addonString(30421).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://www.popologynow.com/wp-content/uploads/2016/05/Meghan-Trainor-Thats-What-She-Said.jpg"))
	
	'''Michael Jackson'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PL3CF35F99B7B4A227')
	addDir(addonString(30301).encode('utf-8'),list,17,"https://michaeljacksonisrael.files.wordpress.com/2013/05/69235_majkl-dzhekson_or_michael-jack21.jpg",addonString(30401).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://www.rockfm.mx/rock_tv/lesdoit-michaeljackson.jpg"))
	
	'''Maddona'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PLOOBElWP-gj6hl7PQVcZak9FGri0ppeWG')
	addDir(addonString(30311).encode('utf-8'),list,17,"http://g04.a.alicdn.com/kf/HTB1jqmjIVXXXXbSapXXq6xXFXXX4/%D7%AA%D7%90%D7%A8%D7%99%D7%9A-%D7%94%D7%9E%D7%A1%D7%AA%D7%95%D7%A8%D7%99%D7%9F-%D7%A9%D7%97%D7%A7%D7%A0%D7%99%D7%AA-%D7%A7%D7%95%D7%9C%D7%A0%D7%95%D7%A2-%D7%9E%D7%93%D7%95%D7%A0%D7%94-ciccone-%D7%A4%D7%95%D7%A1%D7%98%D7%A8-%D7%A6%D7%99%D7%95%D7%A8-%D7%93%D7%A7%D7%95%D7%A8%D7%98%D7%99%D7%91%D7%99-%D7%9C%D7%91%D7%99%D7%AA-%D7%91%D7%93-%D7%9E%D7%A9%D7%99-%D7%94%D7%93%D7%A4%D7%A1%D7%94.jpg",addonString(30411).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://weneedfun.com/wp-content/uploads/2015/10/Madonna-HD-Pictures-17.jpg"))
	
	'''Mariah Carey'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PLEB34410B67CCA932')
	addDir(addonString(30313).encode('utf-8'),list,17,"http://www.studentsoftheworld.info/sites/musique/img/2827_Maria_Carey_1.jpg",addonString(30413).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://wallpaperswide.com/download/mariah_carey_2-wallpaper-1920x1080.jpg"))
	
	'''Maroon 5'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_ch=Maroon5VEVO')
	addDir(addonString(30308).encode('utf-8'),list,17,"http://www.aaarena.com/assets/img/Concert_Maroon5.jpg",addonString(30408).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://www.guitarfree.co.il/wp-content/uploads/8bc571dfd3347ae39c1002c81e32536a.jpg"))
	
	'''Pharrell Williams'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_ch=PharrellWilliamsVEVO')
	addDir(addonString(30312).encode('utf-8'),list,17,"http://cdn.bleedingcool.net/wp-content/uploads/2013/10/Pharrell-Williams.jpg",addonString(30412).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://content.acclaimmag.com/content/uploads/2016/04/1398788909Adi_Pharrell.jpg"))
	...
	addDir(addonString(30310).encode('utf-8'),list,17,"http://www.billboard.com/files/styles/promo_650/public/stylus/1077939-roy-orbison-617-409.jpg",addonString(30410).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://fanart.tv/fanart/music/0bbbc496-c7b5-4b3f-bb6d-bd312827d6e5/artistbackground/orbison-roy-503635210f7d1.jpg"))
	
	'''Rihanna'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PL2DC5A0B189256D7D&index=4')
	addDir(addonString(30303).encode('utf-8'),list,17,"http://static1.1.sqspcdn.com/static/f/610086/15180915/1321583897117/Rihanna.jpg?token=kZt1lYEul%2FfTahdORTKehFd28NI%3D/site1/20091127/0023ae9885da0c7990e10d.jpg&pw=200",addonString(30403).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://xdesktopwallpapers.com/wp-content/uploads/2011/08/Rihanna-Pink-Lips-N-Brown-Eyes-Face-Closeups.jpg"))
	
	'''Sam Smith'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30333).encode('utf-8'),list,17,"https://yt3.ggpht.com/-9z_bFRPDMYQ/AAAAAAAAAAI/AAAAAAAAAAA/czjhAF4k4aw/s100-c-k-no/photo.jpg",addonString(30433).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/lf3W5YtcyaY/maxresdefault.jpg"))
	
	'''Taylor Swift'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_ch=TaylorSwiftVEVO')
	addDir(addonString(30304).encode('utf-8'),list,17,"http://upload.wikimedia.org/wikipedia/he/5/58/Taylor_Swift_-_Taylor_Swift_Album_Cover.png",addonString(30404).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://hdcoolwallpapers.com/wp-content/uploads/2015/03/Taylor-Swift-Wallpapers-HD-041.jpg"))
	
	'''Usher'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_ch=UsherVEVO')
	addDir(addonString(30315).encode('utf-8'),list,17,"http://www.usherdaily.com/wp-content/uploads/2015/02/usher-2014-cover-bb36-01-650.jpg",addonString(30415).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/xbkUdPotU3A/maxresdefault.jpg"))
	
	'''Whitney Houston'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	list.append('&youtube_pl=PL201BB89398FE5675')
	addDir(addonString(30314).encode('utf-8'),list,17,"http://img2.timeinc.net/people/i/2012/specials/yearend/obits/whitney-houston-1435.jpg",addonString(30414).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://content2.promiflash.de/article-images/video_1080/whitney-houston-ganz-in-schwarz.jpg"))
...
def CATEGORIES11104(name, iconimage, desc, fanart):
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30351).encode('utf-8'),list,17,"https://wallpaperscraft.com/image/david_bowie_face_fist_sweater_look_3332_1920x1080.jpg",addonString(30451).encode('utf-8'),'1',"", getAddonFanart(background, custom="http://www.monstersandcritics.com/wp-content/uploads/2016/01/david-bowie-album-blackstar.jpg"))
...
def CATEGORIES11105(name, iconimage, desc, fanart):
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30508).encode('utf-8'),list,17,"http://assets.rollingstone.com/assets/images/video/afrojack-pays-tribute-to-mentor-david-guetta-20131023/101613-afrojack-623-1381937652.jpg",addonString(30509).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/FA4p6buNHEY/maxresdefault.jpg"))
	
	'''Armin Van Buuren'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30510).encode('utf-8'),list,17,"https://s3.amazonaws.com/webassets.ticketmob.com/ES/images/comedians/Armin-Van-Buuren-1.jpg",addonString(30511).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://wallpaperbeta.com/wallpaper/armin_van_buuren_dj_man_hd-wallpaper-380351.jpg"))
	
	'''Calvin Harris'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30516).encode('utf-8'),list,17,"http://www.billboard.com/files/styles/article_main_image/public/media/calvin-harris-press-gavin-bond-2015-billboard-650.jpg",addonString(30517).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://fanart.tv/fanart/music/8dd98bdc-80ec-4e93-8509-2f46bafc09a7/artistbackground/harris-calvin-549a3f22a389c.jpg"))
	
	'''Deadmau5'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30512).encode('utf-8'),list,17,"http://assets.rollingstone.com/assets/2014/article/deadmau5-replies-to-arcade-fires-anti-edm-jab-whats-your-problem-20140424/15140/_original/1035x702-20140424-deadmau5-x1800-1398358641.jpg",addonString(30513).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/f_1qLR1ns3w/maxresdefault.jpg"))
	
	'''Hardwell'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30502).encode('utf-8'),list,17,"https://he.wikipedia.org/wiki/%D7%94%D7%90%D7%A8%D7%93%D7%95%D7%95%D7%9C#/media/File:Hardwell.jpg",addonString(30503).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://fanart.tv/fanart/music/170d6637-36e0-49dd-a225-c4fd5b77a285/artistbackground/hardwell-52572f7f6e752.jpg"))
	
	'''Martin Garrix'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30506).encode('utf-8'),list,17,"http://cdn.wegotthiscovered.com/wp-content/uploads/Garrix_Martin.jpg",addonString(30507).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://images2.alphacoders.com/552/552649.jpg"))
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30504).encode('utf-8'),list,17,"https://he.wikipedia.org/wiki/%D7%A1%D7%A7%D7%A8%D7%99%D7%9C%D7%A7%D7%A1#/media/File:Skrillex.jpg",addonString(30505).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://wallpaperscraft.com/image/skrillex_glasses_haircut_shirt_look_7828_1920x1080.jpg"))
	
	'''Steve Aoki'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30514).encode('utf-8'),list,17,"https://pbs.twimg.com/profile_images/614130977812684800/i-ivLi_n.png",addonString(30515).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/1b4WZtfkFZQ/maxresdefault.jpg"))
	
	'''Tiësto'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(30500).encode('utf-8'),list,17,"https://he.wikipedia.org/wiki/%D7%98%D7%99%D7%99%D7%A1%D7%98%D7%95#/media/File:DJ_Tiesto2005.jpg",addonString(30501).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="http://www.shauntmax30.com/data/out/42/1308824-ruisufang-music-tiesto.jpg"))
...
def CATEGORIES118(name, iconimage, desc, fanart):
	...
	addDir(addonString(30707).encode('utf-8'),list,17,"https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Dvorak.jpg/220px-Dvorak.jpg",addonString(30708).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://ichef.bbci.co.uk/images/ic/1920x1080/p01yqb0g.jpg"))
	...
	addDir(addonString(30711).encode('utf-8'),list,17,"http://iw.hdclassicalmusic.com/data/305/305_radiothumbnail.jpg",addonString(30712).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/ydbXpcgGVJQ/maxresdefault.jpg"))
	...
	addDir(addonString(30709).encode('utf-8'),list,17,"https://upload.wikimedia.org/wikipedia/commons/a/a3/Ennio_Morricone_Cannes_2012.jpg",addonString(30710).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://images6.alphacoders.com/309/309548.jpg"))
	...
	addDir(addonString(30705).encode('utf-8'),list,17,"http://static.universal-music.de/asset_new/279645/60/view/Luciano-Pavarotti.jpg",addonString(30706).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/aMZsx4O7P4A/maxresdefault.jpg"))
	...
	addDir(addonString(30703).encode('utf-8'),list,17,"https://upload.wikimedia.org/wikipedia/commons/9/96/Beethoven_wiki.jpg",addonString(30704).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/8oqRV3tBTvk/maxresdefault.jpg"))
	...
	addDir(addonString(30701).encode('utf-8'),list,17,"https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Wolfgang-amadeus-mozart_1.jpg/200px-Wolfgang-amadeus-mozart_1.jpg",addonString(30702).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="https://i.ytimg.com/vi/-ir9hSJWYJ4/maxresdefault.jpg"))
