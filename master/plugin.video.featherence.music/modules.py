...
def CATEGORIES():
	...
	addDir(addonString(100).encode('utf-8'),'MyMusic',100,featherenceserviceicons_path + 'star.png',addonString_servicefeatherence(32800).encode('utf-8'),'1',50, getAddonFanart(100)) #My Music
	addDir(addonString(101).encode('utf-8'),'',101,featherenceserviceicons_path + 'sod.png',addonString_servicefeatherence(32099).encode('utf-8') % (addonString(101).encode('utf-8')),'1',50, getAddonFanart(101)) #Israeli Music
	addDir(addonString(111).encode('utf-8'),'',111,featherenceserviceicons_path + 'us.png',addonString_servicefeatherence(32099).encode('utf-8') % (addonString(111).encode('utf-8')),'1',50, getAddonFanart(101)) #Foreign Music
	'''---------------------------'''
...
def CATEGORIES101(name, iconimage, desc, fanart):
	'''Israeli Music'''
	addDir(addonString(101).encode('utf-8'),'',10101,featherenceserviceicons_path + "music.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(101).encode('utf-8')),'1',58, getAddonFanart(10101, default="")) #Israeli Music
	addDir(addonString(102).encode('utf-8'),'',10102,featherenceserviceicons_path + "karaoke.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(102).encode('utf-8')),'1',58, getAddonFanart(10102, default="http://www.totalsingersupport.com/wp-content/uploads/2012/11/Sexy_Singing_Amit_Friedman.jpg")) #Israeli Karaoke
	addDir(addonString(104).encode('utf-8'),'',10104,featherenceserviceicons_path + "guitar.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(104).encode('utf-8')),'1',58, getAddonFanart(10104, default="https://upload.wikimedia.org/wikipedia/commons/7/72/Flickr_-_Government_Press_Office_(GPO)_-_Shlomo_Artzi_performing_at_a_rock_festival_in_the_Red_Sea.jpg")) #Israeli Liveshows
	
	addDir(addonString(106).encode('utf-8'),'',10106,featherenceserviceicons_path + "music.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(106).encode('utf-8')),'1',58, getAddonFanart(10106)) #Mizrahit Music
	addDir(addonString(107).encode('utf-8'),'',10107,featherenceserviceicons_path + "karaoke.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(107).encode('utf-8')),'1',58, getAddonFanart(10107, default="http://www.totalsingersupport.com/wp-content/uploads/2012/11/Sexy_Singing_Amit_Friedman.jpg")) #Mizrahit Karaoke
	addDir(addonString(109).encode('utf-8'),'',10109,featherenceserviceicons_path + "guitar.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(109).encode('utf-8')),'1',58, getAddonFanart(10108, default="http://www.hdwallpapersnew.net/wp-content/uploads/2015/12/tomorrowland-full-hd-wallpaper-download-images-free.jpg")) #Mizrahit Liveshows
	#addDir(addonString(105).encode('utf-8'),'',10105,featherenceserviceicons_path + "microphone.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(105).encode('utf-8')),'1',58, getAddonFanart(10105)) #Israeli Djs

def CATEGORIES111(name, iconimage, desc, fanart):
	'''Foreign Music'''
	addDir(addonString(111).encode('utf-8'),'',11101,featherenceserviceicons_path + "music.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(111).encode('utf-8')),'1',58, getAddonFanart(11101)) #Foreign Music
	addDir(addonString(112).encode('utf-8'),'',11102,featherenceserviceicons_path + "karaoke.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(112).encode('utf-8')),'1',58, getAddonFanart(11102, default="http://www.totalsingersupport.com/wp-content/uploads/2012/11/Sexy_Singing_Amit_Friedman.jpg")) #Foreign Karaoke
	addDir(addonString(114).encode('utf-8'),'',11104,featherenceserviceicons_path + "guitar.png",addonString_servicefeatherence(32099).encode('utf-8') % (addonString(114).encode('utf-8')),'1',58, getAddonFanart(11104, default="http://www.hdwallpapersnew.net/wp-content/uploads/2015/12/tomorrowland-full-hd-wallpaper-download-images-free.jpg")) #Foreign Liveshows
...
def CATEGORIES10101(name, iconimage, desc, fanart):
	...
	'''חיפוש'''
	addDir(localize(137),'שיר',3,featherenceserviceicons_path + 'se.png',addonString_servicefeatherence(23).encode('utf-8') % (addonString(2).encode('utf-8')),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10101).encode('utf-8'),list,17,'http://images.mouse.co.il/storage/7/f/eviatar-ggg.jpg',addonString(101010).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10102).encode('utf-8'),list,17,'http://images.mouse.co.il/storage/a/d/Avraham_Tal_490.jpg',addonString(101020).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10105).encode('utf-8'),list,17,'http://img.mako.co.il/2013/05/21/etnix_prn_c.jpg',addonString(101050).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10106).encode('utf-8'),list,17,'http://www.yosmusic.com/images/articles/big/fortis1284-b.jpg',addonString(101060).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10108).encode('utf-8'),list,17,'http://i.ytimg.com/vi/9fkcGdgj-iI/hqdefault.jpg',addonString(101080).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10111).encode('utf-8'),list,17,'http://images1.calcalist.co.il/PicServer2/20122005/158200/YE0415562_l.jpg',addonString(101110).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10113).encode('utf-8'),list,17,'https://i.ytimg.com/i/BbOw6LiHmj6L9o_HlMvKKg/mq1.jpg?v=51c9be2d',addonString(101130).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10148).encode('utf-8'),list,17,'https://i.ytimg.com/vi/vxA1AlH9o-0/hqdefault.jpg',addonString(101480).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom="")) 
	...
	addDir(addonString(10121).encode('utf-8'),list,17,'http://www.nrg.co.il/images/archive/408x322/692/069.jpg',addonString(101210).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))

	'''מזי כהן'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLBDIuIv7lLh8rmjkHMsDgGGsr9HWTdGeE')
	addDir(addonString(10120).encode('utf-8'),list,17,'https://i.ytimg.com/vi/3JAAD8Ptq00/maxresdefault.jpg',addonString(101200).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10123).encode('utf-8'),list,17,'https://i.ytimg.com/i/7cwmZGtlWPDkkEWsxkZd-Q/mq1.jpg?v=54998b82',addonString(101230).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10126).encode('utf-8'),list,17,'http://msc.wcdn.co.il/w/w-700/253820-5.jpg',addonString(101260).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''נתן גושן'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLEgDwaW-dRjrbcf8HWbaOR7E3c-087y5M')
	addDir(addonString(10127).encode('utf-8'),list,17,'https://upload.wikimedia.org/wikipedia/he/2/27/%D7%A0%D7%AA%D7%9F_%D7%92%D7%95%D7%A9%D7%9F.jpg',addonString(101270).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	 
	'''עברי לידר'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL4731BCED6938743B')
	addDir(addonString(10130).encode('utf-8'),list,17,'http://media.shironet.mako.co.il/media/performers/heb/0/764/profile/764_t275.jpg?rnd=58',addonString(101300).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10132).encode('utf-8'),list,17,'https://yt3.ggpht.com/-vsBWN1RBQuk/AAAAAAAAAAI/AAAAAAAAAAA/SWZEbbG5oUY/s100-c-k-no/photo.jpg',addonString(101320).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10138).encode('utf-8'),list,17,'http://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/KerenPelesNew.jpg/375px-KerenPelesNew.jpg',addonString(101380).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''ריטה'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLf7LrXQb_2uFQ4QVEj4t05pLgW_Fmuopo')
	addDir(addonString(10139).encode('utf-8'),list,17,'http://img.mako.co.il/2013/02/07/rita_promo_bww_c.jpg',addonString(101390).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''רמי קליינשטיין'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLtH1TqrerKR1oLff98mr-svFZWIq2fjvO&index=3')
	addDir(addonString(10140).encode('utf-8'),list,17,'http://images1.ynet.co.il/PicServer2/28102008/1770103/2_wh.jpg',addonString(101400).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''שירי מימון'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLtH1TqrerKR0V6jazm82SHiObpILrObcY')
	addDir(addonString(10141).encode('utf-8'),list,17,'http://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Sm_album3.jpg/250px-Sm_album3.jpg',addonString(101410).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10142).encode('utf-8'),list,17,'https://yt3.ggpht.com/-6DiGw2l8Nrk/AAAAAAAAAAI/AAAAAAAAAAA/3qnrk75SjaA/s100-c-k-no/photo.jpg',addonString(101420).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))

	'''שלמה ארצי'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLTojoXqu-e3l-d7nqjHRGjxsF8W77L50f')
	addDir(addonString(10144).encode('utf-8'),list,17,'http://www.nrg.co.il/images/archive/465x349/1/403/734.jpg',addonString(101440).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''שלישית גשר הירקון''' 
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLWb1bV-0WydPLmTK9orqNOigyeSGi0KW7')
	addDir(addonString(10149).encode('utf-8'),list,17,'https://www.kedem-auctions.com/sites/default/files/sale/1300/19724.jpg',addonString(101490).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10102(name, iconimage, desc, fanart):
	...
	CATEGORIES_RANDOM(background,fanart)
	'''חיפוש'''
	addDir(localize(137),'קריוקי',3,featherenceserviceicons_path + 'se.png',addonString_servicefeatherence(23).encode('utf-8') % (localize(13327)),'1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10104(name, iconimage, desc, fanart):
	...
	CATEGORIES_RANDOM(background,fanart)
	'''חיפוש'''
	addDir(localize(137),'הופעה חיה',3,featherenceserviceicons_path + 'se.png',addonString_servicefeatherence(23).encode('utf-8') % (addonString(1).encode('utf-8')),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10106).encode('utf-8'),list,17,'http://img.mako.co.il/2010/10/22/dan_toren_15c.jpg',addonString(101060).encode('utf-8'),'1', 50, getAddonFanart(background, default=fanart, custom=""))
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(10133).encode('utf-8'),list,17,'https://i.ytimg.com/i/o4y7A6EF2tZ1Q2Oxx64HNQ/mq1.jpg?v=520b5fde',addonString(101330).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))

	'''פאר טסי'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(10135).encode('utf-8'),list,17,'https://yt3.ggpht.com/-XdArdL_W374/AAAAAAAAAAI/AAAAAAAAAAA/phGLZNk8iwU/s100-c-k-no/photo.jpg',addonString(101350).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''קובי אפללו'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(10136).encode('utf-8'),list,17,'https://yt3.ggpht.com/-W5wjK70SQ1U/AAAAAAAAAAI/AAAAAAAAAAA/Ibov9BPmodU/s100-c-k-no/photo.jpg',addonString(101360).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''קובי פרץ'''
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(10137).encode('utf-8'),list,17,'https://i.ytimg.com/i/GYqX6zfso91VDawbH_Nukw/mq1.jpg?v=4f5f486f',addonString(101370).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(10141).encode('utf-8'),list,17,'https://yt3.ggpht.com/-33p31sJqT88/AAAAAAAAAAI/AAAAAAAAAAA/taeHwLul6Io/s100-c-k-no/photo.jpg',addonString(101410).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(10143).encode('utf-8'),list,17,'https://i.ytimg.com/i/GaHPMv8YIv_0HfRDQQ44cA/mq1.jpg?v=af5444',addonString(101430).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(10145).encode('utf-8'),list,17,'https://i.ytimg.com/i/0m-czKbg-tL7J61RDdU1rg/mq1.jpg?v=54ac3da1',addonString(11450).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10106(name, iconimage, desc, fanart):
	...
	addDir(addonString(10103).encode('utf-8'),list,17,'http://www.atzuma.co.il/uploaded/13112175e8e2be3e53e7dc74153479b3a0c726.jpg',addonString(101030).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10107).encode('utf-8'),list,17,'http://www.klr-lior.com/wp-content/gallery/omanim/dudu_aharon-hero_c.jpg',addonString(101070).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10112).encode('utf-8'),list,17,'http://img.mako.co.il/2012/08/23/revivo_project_purple_c.jpg',addonString(101120).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''חיים משה'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL015121DF81A43072')
	addDir(addonString(10114).encode('utf-8'),list,17,'http://images.one.co.il/images/mag/450_250/gg789176.jpg',addonString(101140).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''יעקב חתן'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_ch=MrBeitarj')
	addDir(addonString(10116).encode('utf-8'),list,17,'https://yt3.ggpht.com/-_rt6N50COLw/AAAAAAAAAAI/AAAAAAAAAAA/F_g5RBGIXfo/s100-c-k-no/photo.jpg',addonString(101160).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10118).encode('utf-8'),list,17,'http://bsn.co.il/sites/default/files/styles/home_page_main_story_image_480x269/public/%D7%9C%D7%99%D7%90%D7%95%D7%A8%20%D7%A0%D7%A8%D7%A7%D7%99%D7%A1.jpg?itok=nVnP8pg-',addonString(101180).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	 	
	'''מושיק עפיה'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLtH1TqrerKR062w68GunrKtCIUkjZ8L4H')
	addDir(addonString(10122).encode('utf-8'),list,17,'https://yt3.ggpht.com/-4IayEL0C0Rs/AAAAAAAAAAI/AAAAAAAAAAA/kEV66on9DOM/s100-c-k-no/photo.jpg',addonString(101220).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	 
	'''מאור אדרי'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLmUWHf2-pPZEsNbXMoJYoA1O-2zGJEtHv')
	addDir(addonString(10124).encode('utf-8'),list,17,'http://img.mako.co.il/2012/09/12/maor_edri_suit_c.jpg',addonString(101240).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10125).encode('utf-8'),list,17,'https://i.ytimg.com/i/0ebT4a-IyuY61X8py3nzsg/mq1.jpg?v=52124db3',addonString(101250).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''עדן בן זקן'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL7xgp7CnQHVV0wx4TumlDId__ao64-Ikp')
	addDir(addonString(10146).encode('utf-8'),list,17,'http://img.mako.co.il/2015/05/28/EDENBENZAKEN_c.jpg',addonString(101460).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(10145).encode('utf-8'),list,17,'https://i.ytimg.com/i/0m-czKbg-tL7J61RDdU1rg/mq1.jpg?v=54ac3da1',addonString(101450).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list.append('&youtube_pl=PL015121DF81A43072')
	addDir(addonString(10147).encode('utf-8'),list,17,'http://images.one.co.il/images/mag/450_250/gg789176.jpg',addonString(101470).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10107(name, iconimage, desc, fanart):
	...
	list = []
	list.append('&youtube_se='+commonsearch)
	addDir(addonString(10129).encode('utf-8'),list,17,'https://yt3.ggpht.com/-2gpbz_o3W7I/AAAAAAAAAAI/AAAAAAAAAAA/PfzwwLycsmo/s100-c-k-no/photo.jpg',addonString(101290).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10109(name, iconimage, desc, fanart):
	...
	'''אקראי'''
	list = []
	#addDir(localize(590),list,17,'http://reallifeglobal.com/wp-content/uploads/2012/06/music.jpg?467a33',addonString(590).encode('utf-8'),'1',"http://reallifeglobal.com/wp-content/uploads/2012/06/music.jpg?467a33", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES11101(name, iconimage, desc, fanart):
	...
	CATEGORIES_RANDOM(background,fanart)
	'''חיפוש'''
	addDir(localize(137),'song',3,featherenceserviceicons_path + 'se.png',addonString_servicefeatherence(23).encode('utf-8') % (addonString(2).encode('utf-8')),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(11127).encode('utf-8'),list,17,'http://cdn.cultofmac.com/wp-content/uploads/2015/11/adele-third-album-25.jpg',addonString(111270).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Aretha Franklin'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=-aVCoKV6XpVJ8U1wNNOkbo6BzgCdf83m')
	addDir(addonString(11126).encode('utf-8'),list,17,"http://sandiegofreepress.org/wp-content/uploads/2013/01/ARETHA-FRANKLIN-QUEEN-OF-SOUL.jpg",addonString(111260).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Beyonce'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=arPDo5YMm5RA7XMeJtn5HFDdXPed4A-X')
	addDir(addonString(11102).encode('utf-8'),list,17,"http://factmag-images.s3.amazonaws.com/wp-content/uploads/2013/05/beyonce-5.13.20132.jpg",addonString(111020).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Bob Marley'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLF76A601FD261FE55') 
	addDir(addonString(11122).encode('utf-8'),list,17,"http://imgc.allpostersimages.com/images/P-473-488-90/65/6544/ATK4100Z/posters/bob-marley-colors.jpg/300px-Bob-Marley-in-Concert_Zurich_05-30-80.jpg",addonString(111220).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Bob Dylan'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL7B7E250ABE8B4E64&index=2&spfreload=1')
	addDir(addonString(11123).encode('utf-8'),list,17,"http://www.rockbandaide.com/wp-content/uploads/2014/02/Bob-Dylan-Times-are-Changing-C10113356.jpg",addonString(111230).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Britney Spears'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL595EC905D80443EB')
	addDir(addonString(11150).encode('utf-8'),list,17,"http://guardianlv.com/wp-content/uploads/2013/12/Britney-Spears-Hits-Vegas-With-Piece-of-Me-Concert-Series-e1388228163153.jpg",addonString(111500).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Coldplay'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLD88DB02A8CA3EBC2')
	addDir(addonString(11129).encode('utf-8'),list,17,"http://static.guim.co.uk/sys-images/Guardian/Pix/pictures/2011/10/12/1318414177419/Coldplay-007.jpg",addonString(111290).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''David Bowie'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL4FA0D24F56BD0191')
	addDir(addonString(11151).encode('utf-8'),list,17,"https://wallpaperscraft.com/image/david_bowie_face_fist_sweater_look_3332_1920x1080.jpg",addonString(111510).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Elton John'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLA910D381CD5AF74E')
	addDir(addonString(11152).encode('utf-8'),list,17,"http://i.huffpost.com/gen/2722330/images/o-ELTON-JOHN-facebook.jpg",addonString(111520).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(11120).encode('utf-8'),list,17,"http://static.europosters.cz/image/750/plakatok/elvis-presley-portrait-i9038.jpg/375px-Elvis_Presley_promoting_Jailhouse_Rock.jpg",addonString(111200).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Eric Clapton'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLnTKYzbTaPq4yjmTe5CwzpRUvHlJspIO7')
	addDir(addonString(11124).encode('utf-8'),list,17,"http://rock.amazingradios.com/wp-content/uploads/2014/10/eric-clapton-9.jpg",addonString(111240).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Jennifer Lopez'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLC9944199588E8EE8')
	addDir(addonString(11118).encode('utf-8'),list,17,"http://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Jennifer_Lopez_GLAAD_2014.jpg/375px-Jennifer_Lopez_GLAAD_2014.jpg",addonString(111180).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Jean Michel Jarre'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL0X6k9ILt02rs8SYwNfNxgGHTDzTA-eWI')
	addDir(addonString(11131).encode('utf-8'),list,17,"http://www.whale.to/c/zs107kz4jarre.jpg",addonString(111310).encode('utf-8'),'1',"electronic music", getAddonFanart(background, default=fanart, custom=""))
	
	'''Michael Jackson'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL3CF35F99B7B4A227')
	addDir(addonString(11101).encode('utf-8'),list,17,"https://michaeljacksonisrael.files.wordpress.com/2013/05/69235_majkl-dzhekson_or_michael-jack21.jpg",addonString(111010).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir(addonString(11113).encode('utf-8'),list,17,"http://www.studentsoftheworld.info/sites/musique/img/2827_Maria_Carey_1.jpg",addonString(111130).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Roy Orbison'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PLvPrczMM8gz3y1Iboy6CsZ432HjCWUQgR&index=15')
	addDir(addonString(11110).encode('utf-8'),list,17,"http://www.billboard.com/files/styles/promo_650/public/stylus/1077939-roy-orbison-617-409.jpg",addonString(111100).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Rihanna'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL2DC5A0B189256D7D&index=4')
	addDir(addonString(11103).encode('utf-8'),list,17,"http://static1.1.sqspcdn.com/static/f/610086/15180915/1321583897117/Rihanna.jpg?token=kZt1lYEul%2FfTahdORTKehFd28NI%3D/site1/20091127/0023ae9885da0c7990e10d.jpg&pw=200",addonString(111030).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Taylor Swift'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_ch=TaylorSwiftVEVO')
	addDir(addonString(11104).encode('utf-8'),list,17,"http://upload.wikimedia.org/wikipedia/he/5/58/Taylor_Swift_-_Taylor_Swift_Album_Cover.png",addonString(111040).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Usher'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_ch=UsherVEVO')
	addDir(addonString(11115).encode('utf-8'),list,17,"http://www.usherdaily.com/wp-content/uploads/2015/02/usher-2014-cover-bb36-01-650.jpg",addonString(111150).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''Whitney Houston'''
	list = []
	list.append('&youtube_se='+commonsearch)
	list.append('&youtube_pl=PL201BB89398FE5675')
	addDir(addonString(11114).encode('utf-8'),list,17,"http://img2.timeinc.net/people/i/2012/specials/yearend/obits/whitney-houston-1435.jpg",addonString(111140).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES11102(name, iconimage, desc, fanart):
	...
	CATEGORIES_RANDOM(background,fanart)
	'''חיפוש'''
	addDir(localize(137),'karaoke',3,featherenceserviceicons_path + 'se.png',addonString_servicefeatherence(23).encode('utf-8') % (localize(13327)),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(11130).encode('utf-8'),list,17,"http://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Believe_Tour_7%2C_2012.jpg/375px-Believe_Tour_7%2C_2012.jpg",addonString(111300).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list = []
	list.append('&youtube_se='+commonsearch+'')
	addDir(addonString(11133).encode('utf-8'),list,17,"https://yt3.ggpht.com/-9z_bFRPDMYQ/AAAAAAAAAAI/AAAAAAAAAAA/czjhAF4k4aw/s100-c-k-no/photo.jpg",addonString(111330).encode('utf-8'),'1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES11104(name, iconimage, desc, fanart):
	...
	CATEGORIES_RANDOM(background,fanart)
	'''חיפוש'''
	addDir(localize(137),'liveshow',3,featherenceserviceicons_path + 'se.png',addonString_servicefeatherence(23).encode('utf-8') % (addonString(1).encode('utf-8')),'1',"", getAddonFanart(background, default=fanart, custom=""))
