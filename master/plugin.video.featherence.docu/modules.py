...
def CATEGORIES():
	...
	addDir(addonString(104).encode('utf-8'),'',104,'http://orig07.deviantart.net/ff1a/f/2009/033/1/3/science_wallpaper_by_hamdanzinha.jpg',addonString_servicefeatherence(32099).encode('utf-8') % (addonString(104).encode('utf-8')),'1',50, getAddonFanart(104, default="http://wallpapercave.com/wp/582gycq.jpg")) #Science
	addDir(addonString(107).encode('utf-8'),'',107,'http://www.muralswallpaper.co.uk/sites/default/files/styles/full_lightbox/public/product_images/Cute-Animals-Kids-Wallpaper-Mural.jpg?itok=F5n249_x',addonString_servicefeatherence(32099).encode('utf-8') % (addonString(107).encode('utf-8')),'1',50, getAddonFanart(107, default="")) #Kids
	addDir(addonString(108).encode('utf-8'),'',108,'http://in.bgu.ac.il/welcome/EventGalleries/%D7%9C%D7%A9%D7%95%D7%9F%20%D7%A2%D7%91%D7%A8%D7%99%D7%AA.jpg',addonString_servicefeatherence(32099).encode('utf-8') % (addonString(108).encode('utf-8')),'1',50, getAddonFanart(108, default="https://i.ytimg.com/vi/JiRWesm6e04/maxresdefault.jpg")) #Hebrew Subtitle
	addDir(addonString(110).encode('utf-8'),'',110,'http://crownheights.org/wp-content/uploads/2015/07/art.jpg',addonString_servicefeatherence(32099).encode('utf-8') % (addonString(110).encode('utf-8')),'1',50, getAddonFanart(110, default="http://hdwallpapersd.com/wp-content/uploads/2015/08/amazing-street-art-best-3d-graffiti-hd-wallpaper-desktop.jpg")) #Art
...
def CATEGORIES101(name, iconimage, desc, fanart):
	...
	addDir("Nature Ultra HD",list,17,'http://www.lyfaces.com/wallpaper/download/download-wallpaper-3840x2160-water-lilies-leaves-pond-4k-ultra-hd-nature-wallpaper-.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))		
	
	'''Earth Touch'''
	list = []
	list.append('&custom8=plugin://plugin.video.earthtouch/')
	addDir('Earth Touch',list,8,"http://www.earthtouchnews.com/media/1074524/earth-touch-insider_series-poster_2_GalleryLarge.jpg","",'',50, getAddonFanart(background, default=fanart, custom=""))

	

 
	'''בעלי חיים'''
	addDir(addonString(10101),'',10101,'http://3.bp.blogspot.com/-GmdLk2R6ahA/T55Ud9aXCcI/AAAAAAAABY4/4Z9aMnM0Ukc/s1600/Blue-Butterfuly-Latest-Animal-Wallpaper-2012.jpg',addonString(101010),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''צומח'''
	addDir(addonString(10102),'',10102,'https://lh5.ggpht.com/rJg02fFypSfx2mL6BMWEN__3Je-E-sy2ZDgZs2PNnnFLawi2b1QtL9S_GtY5sPLXPw=h900',addonString(101020),'1',"", getAddonFanart(background, default=fanart, custom=""))
	

	'''מקומות'''
	addDir(addonString(10103),'',10103,'https://s-media-cache-ak0.pinimg.com/originals/f6/7c/e8/f67ce86161d17cbde49bac13be0ea023.jpg',addonString(101030),'1',"", getAddonFanart(background, default=fanart, custom=""))

	CATEGORIES101A(name, iconimage, desc, fanart) # עמוד הבא
...
def CATEGORIES10101(name, iconimage, desc, fanart):
	...
	addDir('Lions',list,17,'http://3.bp.blogspot.com/-Iff7IaN3DKI/UeUqIwYg3ZI/AAAAAAAAAZ4/1qJiCmolK7M/s1600/lion-photo.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Giraffe',list,17,'http://ww2.valdosta.edu/~sybashlor/giraffe.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Elephant',list,17,'http://www.turtlehurtled.com/wp-content/uploads/2013/06/Elephant.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Tiger',list,17,'http://www.the-south-asian.com/april2001/bengal_tiger.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Monkey',list,17,'http://www.happytrailsindonesia.com/uploads/img/8/Monkey%20Indonesia.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Birds',list,17,'http://nice-animals.com/wp-content/uploads/2013/02/colorful-birds-02.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Fish',list,17,'http://corural.com/wp-content/uploads/2014/10/great-barrier-reef-fish.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Shark',list,17,'http://marinesciencetoday.com/wp-content/uploads/2009/10/Blacktip-Reef-Shark-Carcharhinus-melanopterus-Bora-Bora-Photo-by-Duncan-Rawlinson.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Snakes',list,17,'http://www.888reptiles.co.uk/user/products/large/amberstripe.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Dogs',list,17,'http://images4.fanpop.com/image/photos/15300000/Basset-Hound-hound-dogs-15363087-800-600.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10102(name, iconimage, desc, fanart):
	...
	addDir("Plant's",list,17,'http://www.laspilitas.com/images/grid24_24/10506/images/native-plants/bouquet.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("Tree's",list,17,'http://memolition.com/wp-content/uploads/2015/07/collection-of-beautiful-pictures-from-around-the-world-23781.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("Orchid",list,17,'http://1.bp.blogspot.com/-ysKfjEIIlvA/U4mlY_TLzHI/AAAAAAAAAGU/Hu6j3XFa3Jg/s1600/Orchid-flower-HD-stock-photos-editable-for-greetings.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''edibl'''
	list = []
	list.append('&youtube_ch=UCsSTiRba-BUnOk0PALOhsug/playlists')
	#addDir("vegetable",list,17,'http://earthdivasblog.com/wp-content/uploads/2010/07/Colorful-vegetables-755879.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("Botany",list,17,'http://chabad4israel.org/tznius4israel/pictures/brooklyn-botanic-garden-new-yor.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("stracture growth & Physiology",list,17,'http://lghttp.32183.nexcesscdn.net/80E716/magento/media/catalog/product/cache/1/image/b460c937cc66d1ece654b0d9d3e637af/e/d/editable-keynote-presentation-timeline-plant-growing.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10103(name, iconimage, desc, fanart):
	...
	addDir('natural places',list,17,'http://naturerandom.com/wp-content/uploads/2014/06/the-17-nature-places-to-see-before-they-disappear-forever-6.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("ocean's",list,17,'http://pix1.agoda.net/hotelimages/972/97258/97258_14012319470018139576.jpg?s=800x600','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("Earth",list,17,'http://orig14.deviantart.net/3632/f/2008/151/4/a/the_planet_earth_by_technoking.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list.append('&youtube_pl=PL0pF26S5a5KD1NcL1zbMrlV7qqj4ro6iw')
	list.append('&youtube_pl=PL8rWKwqFW1l0opYCffj6A4EPi0kgobTuz')
	addDir('natural phenomena and disasters',list,17,'https://wallpaperscraft.com/image/northern_lights_aurora_borealis_uk_2015_100946_800x600.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES102(name, iconimage, desc, fanart):
	...
	addDir("Space Exploration",list,17,'https://wallpaperscraft.com/image/nebula_universe_space_stars_105874_800x600.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("Astronomy",list,17,'http://www.wall321.com/thumbnails/detail/20120615/outer%20space%20stars%20nebulae%201920x1200%20wallpaper_www.wall321.com_24.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("Astronaut",list,17,'http://www.blt.co.uk/wp-content/uploads/2015/12/Astronauts_Nigeria_.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES103(name, iconimage, desc, fanart):
	...
	addDir("History Channel",list,17,'http://download.1wallpaper.net/20150329/the-history-channel-logo-design-black-background-800x600.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("World Wars",list,17,'http://cdn.usborne.com/catalogue/covers/eng/width_223px/87886.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir("Military history",list,17,'https://upload.wikimedia.org/wikipedia/en/d/d0/History_channel_military.png','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES104(name, iconimage, desc, fanart):
	...
	thumb, fanart, summary, description, plot = getAddonInfo(addon)
	addDir('TED','plugin://'+addon,8,thumb,plot,addon,50, getAddonFanart(background, default=fanart, custom=""))
	
	
	'''מדעי החברה והרוח'''
	addDir(addonString(10401),'',10401,'http://2.bp.blogspot.com/-NvLKmKXYxIo/UTfqXTdoYTI/AAAAAAAAGSY/f3q1fXoIxHE/s1600/Social+influence.jpg',addonString(104010),'1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''מדעי הטבע'''
	addDir(addonString(10402),'',10402,'http://www.memrise.com/s3_proxy/?f=uploads/mems/2495464000130417092533.jpeg',addonString(104020),'1',"", getAddonFanart(background, default=fanart, custom=""))

	'''טכנולוגיה'''
	addDir(addonString(10403),'',10403,'http://kommercialize.com/wp-content/uploads/2013/02/iStock_000020426012Small.jpg',addonString(104030),'1',"", getAddonFanart(background, default=fanart, custom=""))	
	...
	list.append('&youtube_pl=PLtSuKq2ke_sn4qo5px_i1jZNVDzz47PVJ')
	list.append('&youtube_pl=PLtSuKq2ke_smyz5y_v6N36MfT5dgA4ORB')
	addDir('מחקר',list,17,'https://www.colourbox.com/preview/4178295-scientific-research.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('ניסויים מדעיים',list,17,'http://1.bp.blogspot.com/-CqEGzAVgHsM/T3cAXa6qyxI/AAAAAAAAAnU/RJiWpn8rM0k/s1600/light_double_slit_experiment.png','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10401(name, iconimage, desc, fanart):
	...
	addDir('ניסויים חברתיים',list,17,'http://www.slidecage.com/wp-content/uploads/2007/08/sliders_800x600_arturo-lecture.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Sociology',list,17,'http://cdn.yourarticlelibrary.com/wp-content/uploads/2013/09/241.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Politics',list,17,'http://wallpoper.com/images/00/28/25/35/flags-politics_00282535.png','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Geography',list,17,'http://wallpaperbeta.com/wallpaper_800x600/map_of_the_world_geographical_geography_800x600_hd-wallpaper-330201.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Architecture',list,17,'http://www.datavisualizationtools.biz/wp-content/uploads/2015/09/architecture-modern-atlanta-modern-architecture-architecture-atlanta-architecture.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Philosophy',list,17,'http://www.thegreatcourses.com/media/catalog/product/cache/1/image/800x600/0f396e8a55728e79b48334e699243c07/4/4/4477---base_image_4.1424272096.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Economics',list,17,'http://gazettereview.com/wp-content/uploads/2015/04/march-jobs-report-economic-news.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('Psychology',list,17,'http://cdn.patch.com/users/22843411/stock/T800x600/20150254e5602e6ff13.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10402(name, iconimage, desc, fanart):
	...
	addDir('מתמטיקה',list,17,'https://lh4.googleusercontent.com/-Glq_hJMk9C8/T3QvhUuGdgI/AAAAAAAAAdQ/iVeLm88VrHY/w800-h800/Magic%2BMath.png','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('ביולוגיה',list,17,'http://cdn.allwallpaper.in/wallpapers/800x600/4746/biology-microscopic-cells-neurons-background-800x600-wallpaper.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('פיסיקה',list,17,'http://www.wall321.com/thumbnails/detail/20120913/mathematics%20chalkboards%20equation%20mind%201024x768%20wallpaper_www.wall321.com_79.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('כימיה',list,17,'http://www.wallpaperhi.com/thumbnails/detail/20111217/26.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list.append('&youtube_pl=PLk-gRvbk-NRQnOvOr-eiEXlIjenN5c1ai')
	list.append('&youtube_pl=PLk-gRvbk-NRQxVEoGmK75H9QQ9qIJTuaZ')
	addDir(' מדעי ומשחקי מח',list,17,'https://c1.staticflickr.com/9/8230/8384110298_da510e0347_b.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('רפואה',list,17,'http://wallpaperbeta.com/wallpaper_800x600/tablets_capsule_medicine_macro_800x600_hd-wallpaper-239312.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10403(name, iconimage, desc, fanart):
	...
	addDir('אקראי',list,17,'http://imgur.com/kcLrrGH.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('קודי',list,17,'http://i.imgur.com/bkWkbHH.png','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('טלפון סלולרי',list,17,'http://wallpapers.windowsace.com/pics/f/r/free-electronics-and-gadgets-iphone-wallpaper-voyager-cell-phone--a-e-ibackgroundz.com.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('מחשבים',list,17,'http://7-themes.com/data_images/out/73/7022381-computer-keyboard-wallpaper.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('אלקטרוניקה',list,17,'http://www.alsglobal.com/~/media/Images/Divisions/Life%20Sciences/Electronics%20Testing/Electronics%204.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('כלי רכב',list,17,'http://wallpaperbeta.com/wallpaper_800x600/porsche_plane_sun_airfield_machine_car_800x600_hd-wallpaper-342079.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('רובוטיקה',list,17,'https://gyulchev.files.wordpress.com/2014/05/robot_blue.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES107(name, iconimage, desc, fanart):
	...
	addDir('National Geographic Kids',list,17,'http://espana.paninimagazine.com/store/media/catalog/product/cache/5/image/800x600/9df78eab33525d08d6e5fb8d27136e95/s/n/snage018_0.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('animal for kids',list,17,'https://d3373c9sxdao7y.cloudfront.net/content/product/large/05328RAV.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('space and planet for kids',list,17,'http://4.bp.blogspot.com/-EB8N_Kjqiws/T4KSeG48w4I/AAAAAAAAA5Q/3hs2tGC3e38/s1600/Display-Cool-Space-Wallpaper.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('planets for kids',list,17,'https://cdn-jr.brainpop.com/topics/plantadaptations/motw_graphic.png','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES108(name, iconimage, desc, fanart):
	...
	addDir('חוצה ישראל',list,17,'https://i.ytimg.com/vi/i9GSeDTY5BE/maxresdefault.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('מקבלים שבת',list,17,'http://www.iba.org.il/pictures/p452860.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('הסטוריה',list,17,'https://upload.wikimedia.org/wikipedia/he/d/d8/%D7%9C%D7%95%D7%92%D7%95_%D7%A2%D7%A8%D7%95%D7%A5_%D7%94%D7%94%D7%99%D7%A1%D7%98%D7%95%D7%A8%D7%99%D7%94.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('דוקו ישראלי',list,17,'http://images.photolight.co.il/photo/2006-06-24/15120.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	
	'''תרבות-חינוכית'''
	list = []
	list.append('&youtube_ch=23Culture')
	addDir('תרבות-חינוכית',list,17,'https://yt3.ggpht.com/-PVEs_ee6CxU/AAAAAAAAAAI/AAAAAAAAAAA/NNkej9cD-YA/s100-c-k-no/photo.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''ערוץ הגיון ומדע'''
	list = []
	list.append('&youtube_ch=ScienceReasonIsrael')
	list.append('&youtube_ch=UCLpn_QJwfehfKuTt0orfYDw')
	addDir('ערוצי הגיון ומדע',list,17,'http://www.iba.org.il/zap/pictures/P670944.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))

	
	#'''אילוף כלבים'''
	#list = []
	#list.append('&youtube_ch=Orenadika73')
	#addDir('אילוף כלבים',list,17,'https://lh6.googleusercontent.com/-04dBifp4BQc/VE9pqg-8-WI/AAAAAAAAACQ/FqqIgmOz0vY/w800-h800/best%2Bdog%2Btrainer.JPG','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('מאקו הרצאות',list,8,"","",'plugin.video.MakoTV',50, getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('דוקו מאקו',list,8,"","",'plugin.video.MakoTV',50, getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('דוקו וואלה',list,8,"","",'',50, getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('ערוץ 8',list,8,"","",'',50, getAddonFanart(background, default=fanart, custom=""))

	
	addon = 'plugin.video.ilten'
	thumb, fanart, summary, description, plot = getAddonInfo(addon)
	addDir('דוקו 10','plugin://'+addon+'/?category=2118',8,thumb,plot,addon,50, getAddonFanart(background, default=fanart, custom=""))
	
	
	addon = 'plugin.video.seretil'
	thumb, fanart, summary, description, plot = getAddonInfo(addon)
	addDir('sertil דוקו','plugin://'+addon+'/?iconimage=http%3a%2f%2fimages.nationalgeographic.com%2fwpf%2fsites%2fcommon%2fi%2fpresentation%2fNGLogo560x430-cb1343821768.png&mode=4&name=%d7%a0%d7%a9%d7%99%d7%95%d7%a0%d7%9c%20%d7%92%d7%90%d7%95%d7%92%d7%a8%d7%a4%d7%99%d7%a7&url=http%3a%2f%2fseretil.me%2fcategory%2f%25D7%25A0%25D7%25A9%25D7%2599%25D7%2595%25D7%25A0%25D7%259C-%25D7%2592%25D7%2599%25D7%2590%25D7%2595%25D7%2592%25D7%25A8%25D7%25A4%25D7%2599%25D7%25A7%2fpage1%2f',8,thumb,plot,addon,50, getAddonFanart(background, default=fanart, custom=""))
	
	addon = 'plugin.video.movixws'
	thumb, fanart, summary, description, plot = getAddonInfo(addon)
	addDir('movix דוקו','plugin://'+addon+'/?description&iconimage=http%3a%2f%2ficons.iconarchive.com%2ficons%2faaron-sinuhe%2ftv-movie-folder%2f512%2fDocumentaries-National-Geographic-icon.png&mode=2&name=Documentary%20-%20%d7%93%d7%95%d7%a7%d7%95%d7%9e%d7%a0%d7%98%d7%a8%d7%99&url=http%3a%2f%2fwww.movix.me%2fgenres%2fDocumentary',8,thumb,plot,addon,50, getAddonFanart(background, default=fanart, custom=""))
	
	addon = 'plugin.video.sdarot.tv'
	thumb, fanart, summary, description, plot = getAddonInfo(addon)
	addDir('sdarot.tv דוקו','plugin://'+addon+'/?mode=2&module=http%3a%2f%2fwww.sdarot.wf%2fseries%2fgenre%2f11%d7%94%d7%99%d7%a1%d7%98%d7%95%d7%a8%d7%99%d7%94&name=%d7%94%d7%99%d7%a1%d7%98%d7%95%d7%a8%d7%99%d7%94&summary&url=all-heb',8,thumb,plot,addon,50, getAddonFanart(background, default=fanart, custom=""))
	
	'''ילדים'''
	addDir(addonString(10801),'',10801,'http://www.disneywallpaper.net/data/media/7/Winnie_the_Pooh_kids.jpg',addonString(108010),'1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES10801(name, iconimage, desc, fanart):
	...
	addDir('קטנטנים בטבע',list,17,'http://4.bp.blogspot.com/-i5yjcp0Hsek/VL3-_9tBpRI/AAAAAAAAjgk/3P6kPNQZDbc/s1600/%D7%A7%D7%99%D7%95%D7%98%D7%99.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''בעלי חיים לילדים ופעוטות'''
	list = []
	list.append('&youtube_id=QcANPfq5V7g')
	addDir('בעלי חיים לילדים ופעוטות',list,17,'https://i.ytimg.com/vi/jMIELC0KFs4/hqdefault.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('גלילאו',list,17,'https://i.ytimg.com/vi/HZ7UHZcIuh0/maxresdefault.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('היה היה',list,17,'http://www.asksheilta.com/wp-content/uploads/2009/06/fond04_8001.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''עולם החיות של הופ'''
	list = []
	list.append('&youtube_id=l3fXEyLWCzI')
	addDir('עולם החיות של הופ',list,17,'https://i.ytimg.com/vi/l3fXEyLWCzI/hqdefault.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('החפרנים',list,17,'http://www.maariv.co.il/HttpHandlers/ShowImage.ashx?id=274624','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	
	'''להיות מדען עם פרופסור דן'''
	list = []
	list.append('&youtube_pl=PL51YAgTlfPj4oR5aIC0Ru5JZA1a1TT-RN')
	addDir('להיות מדען עם פרופסור דן',list,17,'https://static2.timeout.co.il/media/2014/04/2%D7%90%D7%99%D7%94-%D7%90%D7%A4%D7%A8%D7%99%D7%9D_P.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''מה זה מוזה'''
	list = []
	list.append('&youtube_pl=PL51YAgTlfPj4F8EkY07BfV1KhdjmtjX0P')
	addDir('מה זה מוזה',list,17,'http://www.nrg.co.il/images/archive/465x349/1/536/495.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))

	'''מה זה מוזה במעבדה'''
	list = []
	list.append('&youtube_pl=PL51YAgTlfPj59VvVLjLaAiGbFjbqv7sh3')
	addDir('מה זה מוזה במעבדה',list,17,'https://i.ytimg.com/vi/iUyRkPDPr8s/maxresdefault.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''2 2מה זה מוזה במעבדה'''
	list = []
	list.append('&youtube_pl=PLth1a195qHsj20lXv4QqTQ7kb2RLoGxY8')
	addDir( 'מה זה מוזה במעבדה 2',list,17,'https://i.ytimg.com/vi/25zKDuO98IY/sddefault.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''שירים לילדים בנושא חיות'''
	list = []
	list.append('&youtube_id=jMIELC0KFs4')
	addDir('שירים לילדים בנושא חיות',list,17,'https://i.ytimg.com/vi/jMIELC0KFs4/hqdefault.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	
	'''חיות בערוץ לולי'''
	list = []
	list.append('&youtube_pl=PLTleo-h9TFqI2CFuWeFA-Q2Bu3BBHdXqv')
	addDir('חיות בערוץ לולי',list,17,'https://i.ytimg.com/vi/6PBHhtBSpsI/maxresdefault.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))

	'''לולי אוהב חיות'''
	list = []
	list.append('&youtube_id=gO9hyX4s1ko')
	addDir('לולי אוהב חיות',list,17,'http://i.ytimg.com/vi/gO9hyX4s1ko/0.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	
	'''חינוכית לילדים'''
	list = []
	list.append('&youtube_ch=The23Kidz')
	addDir('חינוכית לילדים',list,17,'https://yt3.ggpht.com/-ChQs3ZvwjBI/AAAAAAAAAAI/AAAAAAAAAAA/jiyTOAdmqgo/s100-c-k-no/photo.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))

	
	'''חינוכית בית ספר לשפות'''
	list = []
	list.append('&youtube_ch=23language')
	addDir('חינוכית בית ספר לשפות',list,17,'https://yt3.ggpht.com/-lBNXia5dmco/AAAAAAAAAAI/AAAAAAAAAAA/WdkzNf3TbHE/s100-c-k-no/photo.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
...
def CATEGORIES110(name, iconimage, desc, fanart):
	...
	addDir('צילום',list,17,'https://wallpaperscraft.com/image/canon_clip_art_camera_photography_beach_42535_800x600.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('אומנים',list,17,'http://www.davidpaulkirkpatrick.com/wp-content/uploads/2013/03/van-Gogh-Self-Potrait_1889_1890.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list.append('&youtube_pl=PLvwqC5cvT9A56w--qpeul2oiV0vz95CSm')
	addDir('עבודות אומנות',list,17,'https://wallpaperscraft.com/image/plate_paper_candy_pink_background_crafts_80738_800x600.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	list.append('&youtube_pl=PLvwqC5cvT9A56w--qpeul2oiV0vz95CSm')
	list.append('&youtube_pl=PLvwqC5cvT9A56w--qpeul2oiV0vz95CSm')
	addDir('שרטוט',list,17,'http://orig00.deviantart.net/3a19/f/2013/230/1/8/drawing_michael_ealy_part_two_by_xjorieke-d6io2s8.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('ציור',list,17,'http://www.florenceartacademy.it/blog/wp-content/uploads/2013/07/Gioconda.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
	...
	addDir('פיסול',list,17,'https://s-media-cache-ak0.pinimg.com/736x/ef/06/95/ef0695c68517e3baaf58313d82573984.jpg','','1',"", getAddonFanart(background, default=fanart, custom=""))
