...
def downloads2(file, dest_path):
	fileID = getfileID(file)
	file_ = file
	file_ = file_.replace(" ", "%20")
	DownloadFile("https://www.dropbox.com/s/"+fileID+"/"+file_+"?dl=1", file, temp_path, dest_path)
...
def getfileID(file):
	...
	elif file == "nvram_diff.zip": fileID = 'edryahvqem4ithx' #featherence.user3
	...
	elif file == "Arcade_3P.zip": file = '86hwvrrhp8xzxdx' #featherence.user41
	...
	elif file == "Arcade_FUN.zip": fileID = 'nhcj88dm4k2yovn' #featherence.user3 (guser19!)
	...
	elif file == "Dreamcast_1P_Jet Grind Radio.zip": fileID = "" #
	elif file == "Dreamcast_2P_Daytona USA 2001.zip": fileID = "" #
	...
	elif file == "GameCube_2P_Bloody Roar - Primal Fury.zip": fileID = "0v5w18vgdm4cf0w" #featherence.user27
	...
	elif file == "GameCube_2P_Knockout Kings 2003.zip": fileID = "e1043a31c43y3t7" #featherence.user34
	...
	elif file == "GameCube_1P_Spider Man 2.zip": fileID = "" #featherence.guser32!!!
	elif file == "GameCube_4P_Viewtiful Joe Red Hot Rumble.zip": fileID = "" #featherence.guser32!!!
	...
	elif file == "GameCube_2P_Shadow The Hedgehog.zip": fileID = "s47ibf4z0qmdb0j" #featherence.user43
