...
resolution_force = getsetting('resolution_force')
...
system_path = os.path.join(emulatordata_path, 'system','')
if systemplatformandroid: shader_path = os.path.join(emulatordata_path,'shaders_glsl','')
else: shader_path = os.path.join(emulatordata_path,'shaders','')
...
recording_config_path = os.path.join(emulatordata_path,'recordings','')
...
storageconfigretroarchassets_path = os.path.join(storageconfig_path, 'retroarch', 'assets', '')
storageconfigretroarchassetsxmb_path = os.path.join(storageconfig_path, 'retroarch', 'assets', 'xmb', '')
storageconfigretroarchassetsxmbmonochrome_path = os.path.join(storageconfig_path, 'retroarch', 'assets', 'xmb', 'monochrome', '')
...
remaps_path = os.path.join(emulatordata_path,'remaps','')
remaps_path2 = os.path.join(featherence_emu_module_path,'remaps','')

save_path = os.path.join(emulatordata_path,'save','')
saveMAME_path = os.path.join(emulatordata_path,'save', 'MAME 2014')
saveMAME2_path = os.path.join(emulatordata_path,'save', 'MAME 2014', 'mame')
...
optionsL = [] ; options_L = []
video_driver = getsetting('video_driver') ; optionsL.append('video_driver') ; options_L.append('gl')
...
staticL.append('thumbnails_directory') ; static_L.append(thumbnails_path)
staticL.append('playlist_directory') ; static_L.append(playlist_path)
staticL.append('recording_output_directory') ; static_L.append(recording_output_path)
staticL.append('recording_config_directory') ; static_L.append(recording_config_path)
staticL.append('cache_path') ; static_L.append(cache_path)
staticL.append('resampler_directory') ; static_L.append(resampler_path)
...
staticL.append('config_save_on_exit') ; static_L.append('false')
