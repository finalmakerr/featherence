...
if addonID2 == 'plugin.video.featherence.extreme': api_youtube_featherence = 'AIzaSyCtYPul4iJbXGgxhRKOigImn4McydMqkRA' #featherence.user5
elif addonID2 == 'plugin.video.featherence.kids': api_youtube_featherence = 'AIzaSyCYYphM9eKl4Lq5d9mYIbPEM3YwN8QqVk8' #featherence.user1
elif addonID2 == 'plugin.video.featherence.music': api_youtube_featherence = 'AIzaSyA92zEfJa2-VLtKeZ89qYNeq7nL9PwlZVI' #featherence.user2
elif addonID2 == 'plugin.video.featherence.docu': api_youtube_featherence = 'AIzaSyAyjLqBILXBrd-Tdz7oD5OozRv2xQ089z4' #featherence.user3
elif addonID2 == 'plugin.video.featherence.rofl': api_youtube_featherence = 'AIzaSyChakwriaCsPKRyThP8tSiWND6yiRnOJNU' #featherence.user4
elif systemplatformwindows: api_youtube_featherence = 'AIzaSyCt5Cx2ETbOhnyFbEnSh5HUEOd9ZPUU-Os' #featherence.user6
else: api_youtube_featherence = 'AIzaSyCt5Cx2ETbOhnyFbEnSh5HUEOd9ZPUU-Os' #featherence.user6
