...
def CATEGORIES101A(General_LanguageL, background, background2): #פספוסים
	'''עמוד הבא'''
	list = []
...
def CATEGORIES102A(General_LanguageL, background, background2): #תוכניות
	'''עמוד הבא'''
	list = []
...
def CATEGORIES103A(General_LanguageL, background, background2): #סטנדאפיסטים
	'''עמוד הבא'''
	list = []
